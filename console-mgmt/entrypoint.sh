...
SERVER_OPTS="-Dmgmt.home.dir='$(abs_path '..')'"
...
CLASSPATH_OPTS="'$(abs_path "management-console-runner.jar")'"
...
JAVA_RUN_OPTS="$JAVA_RUN_OPTS $SERVER_OPTS -jar $CLASSPATH_OPTS  ${CONFIG_ARGS#?}"
